...
export interface Product {
    ...
    name: string;
    sellingPrice: number;
    hppCalculationType: "MANUAL" | "AUTOMATIC";
...
export default function ProdukPage() {
    ...
    return (
        <>
            ...
            <div className="relative -mt-32 container mx-auto px-4 pb-12">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-semibold text-gray-800">Daftar Produk</h1>
